...
class Network():
    ...
    def model(self, x):
        ...
        with tf.variable_scope('fc' + str(layer_num)):
            output = fc_layer('fc', output, layer[layer_num], activation='sigmoid', dropout=self.dropout_normal)
    ...
    def run(self, step_limit):
        ...
        with tf.Session() as sess:
            ...
            path = "mlp_mnist/" + str(step_limit) + "shallow"
