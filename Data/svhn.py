...
class SVHN(Utils):
    def __init__(self):
        self.dataset_path = flags.SVHN_DIR
        self.trainset = flags.SVHN_DIR + "train_32x32.mat"
        self.testset = flags.SVHN_DIR + "test_32x32.mat"
    ...
    def process_data(self, file):
        ...
        image_array = self.convert_images2arr(images, pixel_depth=1.0)  #pixel_depth가 1로 되있어 정규화 안됨.
